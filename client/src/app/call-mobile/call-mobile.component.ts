...
@Component({
  selector: 'app-call-mobile',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './call-mobile.component.html',
  styleUrl: './call-mobile.component.css'
})
export class CallMobileComponent implements OnInit, OnDestroy {
  ...
  constructor(private callService: CallService , private route: ActivatedRoute , private router: Router) {}


  async getDataFromUrl(){
    this.route.paramMap.subscribe((params) => {
      this.call_ID = +params.get('call_ID')!;
      this.userId = +params.get('userId')!;
      this.userType = params.get('userType');
      this.userName = params.get('userName')!;

      console.log('Chat ID:', this.call_ID);

      console.log('User ID:', this.userId);
      console.log('User Type:', this.userType);
      console.log('Receiver Type:', this.userName);

      if (!this.call_ID || !this.userId || !this.userType || !this.userName ) {
