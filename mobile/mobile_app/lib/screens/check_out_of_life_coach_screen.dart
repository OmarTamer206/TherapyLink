...
class CheckOutOfLifeCoachScreen extends StatefulWidget {
  const CheckOutOfLifeCoachScreen({super.key});

  @override
  State<CheckOutOfLifeCoachScreen> createState() => _CheckOutScreenState();
}

class _CheckOutScreenState extends State<CheckOutOfLifeCoachScreen> {
  ...
  List<String> appointmentTypeList = ["Video Call"];
