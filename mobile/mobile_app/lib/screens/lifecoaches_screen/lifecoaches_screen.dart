...
import 'package:mobile_app/screens/lifecoaches_screen/widgets/lifecoacheslist_item_widget.dart';
...
class LifeCoachesScreen extends StatelessWidget {
  const LifeCoachesScreen({super.key});
              ...
              children: [
                SizedBox(
                  ...
                  child: CustomAppBar(
                    ...
                    centerTitle: true,
                    title: const AppbarSubtitle(text: "Life Coaches"),
                  ),
                ),
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: Container(
                      ...
                      child: _buildLifeCoachesList(context),
                    ),
                  ),
                ),
  ...
  Widget _buildLifeCoachesList(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return LifeCoachesListItemWidget(
          onViewCoachTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const LifeCoachSOneScreen(), // Navigate to DoctorPage
              ),
            );
          },
        );
