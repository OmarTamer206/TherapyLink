...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2025 at 01:28 AM
...
INSERT INTO `doctor_availability` (`id`, `doctor_ID`, `AvailableDate`, `StartTime`, `EndTime`, `IsReserved`) VALUES
(1, 22, '2025-04-30', '07:01:11', '09:01:11', 0);
...
INSERT INTO `doctor_session` (`session_ID`, `patient_ID`, `doctor_ID`, `scheduled_time`, `cost`, `Duration`, `Created_at`, `rating`, `feedback`, `communication_type`, `report_id`, `refunded`) VALUES
(2, 1, 3, '2025-03-12 22:11:26', 163.42, 118, '2025-02-28 20:18:53', 2, 'Carry deep usually.', 'follow', 1, 1),
(4, 6, 2, '2025-03-03 02:59:47', 108.62, 73, '2025-02-28 20:18:53', 3, 'Fight machine usually job market pull interview.', 'especially', 3, 0),
(12, 7, 3, '2025-04-30 23:26:10', 127.90, 56, '2025-04-30 19:23:09', 3, 'Dark sing audience energy with party pull.', 'follow', 8, 1),
(17, 2, 3, '2025-03-21 08:23:09', 192.92, 37, '2025-02-28 20:23:09', 2, 'Congress shake operation garden.', 'wish', 9, 0),
(22, 2, 3, '2025-03-19 12:19:10', 100.49, 78, '2025-02-28 20:26:00', 1, 'Medical human economy letter their fight.', 'practice', 2, 0),
(26, 2, 3, '2025-03-05 03:22:10', 163.88, 40, '2025-02-28 20:26:00', 2, 'Gun series executive candidate relate.', 'production', 6, 0),
(29, 9, 2, '2025-03-20 06:02:36', 151.69, 54, '2025-02-28 20:26:00', 3, 'Home whose either.', 'yard', 5, 0),
(32, 8, 2, '2025-03-11 04:40:06', 99.26, 52, '2025-02-28 20:35:20', 5, 'Religious laugh because capital ready try sea.', 'nor', 6, 0),
(37, 3, 2, '2025-03-09 04:45:28', 141.30, 90, '2025-02-28 20:35:20', 1, 'Win policy college contain war tell.', 'family', 4, 0),
(40, 8, 2, '2025-03-25 19:59:10', 130.48, 30, '2025-02-28 20:35:20', 4, 'Kitchen account style you memory character.', 'officer', 5, 0);
...
CREATE TABLE `lifecoach_availability` (
  `id` int(11) NOT NULL,
  `lifecoach_ID` int(11) DEFAULT NULL,
  `AvailableDate` date DEFAULT NULL,
  `StartTime` time DEFAULT NULL,
  `EndTime` time DEFAULT NULL,
  `IsReserved` tinyint(1) DEFAULT 0
...
INSERT INTO `lifecoach_availability` (`id`, `lifecoach_ID`, `AvailableDate`, `StartTime`, `EndTime`, `IsReserved`) VALUES
(1, 21, '2025-04-30', '09:02:07', '13:02:07', 1);
...
INSERT INTO `life_coach_session` (`session_ID`, `coach_ID`, `scheduled_time`, `cost`, `Duration`, `Created_at`, `rating`, `feedback`, `refunded`) VALUES
(2, 1, '2025-03-29 11:18:59', 97.66, 75, '2025-02-28 20:35:20', 4, 'Six remember mission daughter final perhaps.', 1);
...
(6, 'Andrew Martinez', 'fcantrell@example.net', ')i8OUT)2L+', '2025-02-28 20:18:53', '1952-03-11', '823.802.4986x1297', 'Divorced', 'No Preference', 'Seat month small project forward.', 'Other', 'https://picsum.photos/702/663', 0),
...
(13, 'Adrian Washington', 'ray93@example.com', '^AVvQlpzY0', '2025-02-28 20:23:09', '1985-11-04', '(373)573-0913', 'Divorced', 'Female', 'Sometimes attention cell democratic.', 'Male', 'https://dummyimage.com/484x89', 0),
...
(37, 'Jessica Powell', 'xbaker@example.org', '!3qOjzXA(0', '2025-02-28 20:35:20', '1981-11-25', '001-764-444-6305x958', 'Divorced', 'Female', 'Responsibility eat stand position understand clearly knowledge.', 'Other', 'https://picsum.photos/631/638', 0),
...
(43, 'omar', 'patient@gmail.com', '$2b$10$H3yhzYC36blatE6GCfXHP.aL4XpEcTop3f6p0WLxBLEu.MsTF3Z0G', '2025-04-17 15:29:28', '0000-00-00', '015534234234', 'single', NULL, NULL, 'Male', NULL, 0),
(44, 'Jana', 'jana@gmail.com', '$2b$10$3Rjtw9LHeTnfbnHF57NAMuQazrtJhPYBt7TPB6H4nJQn25jyNm31O', '2025-04-28 10:51:43', '2005-01-09', '79847287498', 'Single', NULL, NULL, 'Female', NULL, 0),
...
ALTER TABLE `lifecoach_availability`
  ADD PRIMARY KEY (`id`),
  ADD KEY `life_coach_ID` (`lifecoach_ID`);
...
--
ALTER TABLE `lifecoach_availability`
  ADD CONSTRAINT `lifecoach_availability_ibfk_1` FOREIGN KEY (`lifecoach_ID`) REFERENCES `life_coach` (`id`) ON DELETE CASCADE;
